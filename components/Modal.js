...
import { useRouter } from "next/navigation";
   ...
   const ProfileModal = ({showModal, setShowModal, setEdit, profileDetails, edit, setFetch, fetch}) => {
      ...
      return (
        ...
        <div className='flex justify-around items-center'>
         ...
         >
             ...
             {preview && <Image src={preview} alt='user image' width={120} height={120} />}
        ...
        <div className='flex items-center p-2 mt-4'>
                    <h1 className='text-xl w-[20%] relative left-8'>Email:</h1>
                <TextField
